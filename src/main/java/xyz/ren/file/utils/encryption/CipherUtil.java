...
public class CipherUtil {
    ...
    private static String encryptEncode(String algorithm, String data) {
        try {
            ...
            return Base64Util.encodeToString(md.digest(data.getBytes()));
        } catch(Exception ex) {
            ex.printStackTrace();
        }
        return null;
    ...
    public static String HMACEncode(String data, String key) {
        ...
        try {
            ...
            mac.init(k);
            return Base64Util.encodeToString(mac.doFinal(data.getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    private static String DESCipher(String data, String key, int mode) {
        try {
            ...
            cipher.init(mode, k);
            return mode == Cipher.DECRYPT_MODE?new String(cipher.doFinal(Base64Util.decode(data))):Base64Util.encodeToString(cipher.doFinal(data.getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String generatePBESalt() {
        ...
        return Base64Util.encodeToString(salt);
    }
    ...
    private static String PBECipher(String data,String password,String salt,int mode) {
        try {
            ...
            PBEParameterSpec paramSpec = new PBEParameterSpec(Base64Util.decode(salt), 100);
    ...
    private static String AESCipher(String data, String key, String algorithmParameter,int mode) {
        try {
            ...
            return mode==Cipher.DECRYPT_MODE?new String(ecipher.doFinal(Base64Util.decode(data))):Base64Util.encodeToString(ecipher.doFinal(data.getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String RSASign(String data, String privateKey) {
        try {
            ...
            signature.update(Base64Util.decode(data));
    ...
    public static String sign(String sign, String keyStorePath, String alias,String password) {
        try {
            ...
            signature.update(Base64Util.decode(sign));
            return Base64Util.encodeToString(signature.sign());
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @return 返回验证结果
     */
    public static boolean verify(String data, String sign,String certificatePath) throws IOException {
        try {
            // 获得证书
